...
## Data set
### Two read files R1 and R2 of ddRADseq data from five populations were obtained from illumina Hiseq plaftorm.
...
```
### Plotting allelic richness and heterozygosity in each population.
```{r}
...
heteroz
barplot(heteroz$Heterozygosity, main="Plot of genetic diversity in each population country",ylab="Genetic diversity", xlab="population", names= heteroz$Population, las = 2)
```
